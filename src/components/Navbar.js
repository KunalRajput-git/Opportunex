...
const Navbar = () => {
  ...
  return (
    <nav class="duration-500 md:flex w-full md:justify-between md:items-center bg-white  px-6 py-4 rounded-xl md:py-6 md:px-12 md:fixed top-0 left-0 z-10 md:rounded-none">
