  ...
  return (
    <>
      ...
      <div className="flex h-[100vh] overflow-hidden">
        <div className="w-[30%] text-white bg-indigo-800 pt-40 hidden lg:block">
          <div className="w-11/12 m-auto">
            ...
            <div className="mt-8 leading-8 text-lg">
              <h1>Role Title : SDE - Role</h1>
              <h1>Date Applied : 24 January 2021</h1>
              <h1>Location : Delhi,India</h1>
              <h1>Job Link : https://adobe.com</h1>
              <h1>Status : Applied</h1>
              <h1>Contcts : Amul Grops</h1>
              <h1>Notes: Something else</h1>
              <h1>Feedback: Something else</h1>
            </div>
          </div>
        </div>
        <div className="w-full lg:w-[70%]">
          <div className="p-4 gap-4 md:gap-0 flex justify-between items-center md:pt-24 lg:pt-28">
            ...
            <input
              type="search"
              className="border hidden md:block md:w-1/2 p-3 rounded-md"
          ...
          <div className="flex justify-between">
            <div className="md:h-[69vh] w-full md:overflow-x-hidden md:overflow-scroll">
