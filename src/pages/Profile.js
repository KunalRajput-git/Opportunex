      ...
      <div className="flex">
        <div className="md:py-24  w-full">
          ...
          <div className="p-6">
            ...
            <div className="md:w-1/2 flex gap-8 mt-4">
              <button className="flex text-indigo-600 items-center gap-4 p-3 px-6  border rounded-md focus:ring focus:ring-indigo-600">
                <svg
